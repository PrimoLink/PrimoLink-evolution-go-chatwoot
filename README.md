...
Diferente de soluções legadas, o PrimoLink foi desenvolvido para ser **stateless** e **escalável**, utilizando uma stack moderna com PostgreSQL para persistência e Redis para cache de mapeamento ultrarrápido.

---
<p dir="auto"><a target="_blank" rel="noopener noreferrer" href="/slot-primolink-gateway.png"><img src="/primolink-gateway-pt-en-es.png" width="100%" alt="PrimoLink | Gateway | Evolution GO | WuzAPI | Chatwoot" style="max-width: 100%;"></a></p>
---
...
- **WuzAPI:** `[APP_URL]/webhook/wuzapi/[slot_id]`
